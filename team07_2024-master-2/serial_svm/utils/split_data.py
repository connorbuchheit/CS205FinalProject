...
def main(argv = sys.argv):
    ...
    X_train.to_csv(X_data_file.replace('.csv', '_tr.csv'), index=False)
    Y_train.to_csv(Y_data_file.replace('.csv', '_tr.csv'), index=False)
    X_test.to_csv(X_data_file.replace('.csv', '_te.csv'), index=False)
    Y_test.to_csv(Y_data_file.replace('.csv', '_te.csv'), index=False)
